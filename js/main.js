// ===== Dev tool: overlay de grid =====
// Antes vivía como <style>/<script> inline duplicado en cada página;
// centralizado acá. Guardado con "if (!overlay || !toggle) return" como
// el resto de este archivo, así no rompe nada en páginas que no tengan
// el markup (ej. design-system.html, que nunca lo tuvo).
//
// Oculto en cualquier dominio que no sea localhost/127.0.0.1 — "solo me
// sirven en la rama local para trabajar" (a pedido de David). Es
// automático: no depende de acordarse de sacarlo antes de un commit a
// master.
//
// UN solo botón: prende/apaga el overlay. Las columnas siguen el
// breakpoint REAL del viewport (12 / 8 / 4 col según el ancho, vía
// @media en css/components.css) — no hay selector de breakpoint ni
// vista previa en <iframe>: para ver el contenido reacomodado se
// redimensiona la ventana (o el device mode del navegador) y el grid
// acompaña.
(function () {
